...
const ReportForm = () => {
  ...
  const formStructure = {
    ...
    contests: {
      ...
      structure: {
        name: "Наименование конкурса (ФЦП, РНФ и т.д.)",
        application_name: "Наименование заявки (НИР, объем предполагаемого финансирования)",
        leader_fullname: "ФИО руководителя",
        responsible_executor_fullname: "ФИО ответственного исполнителя",
      },
